...
const AITutor = () => {
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: '👋 Hi! I\'m your aerospace and automotive engineering tutor. Ask me anything about rockets, planes, cars, or engineering concepts!'
    }
  ]);
  ...
  const handleSend = async () => {
    ...
    const result = await askGemini(userMessage, conversationHistory);
