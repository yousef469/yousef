  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-900 via-stone-900 to-gray-900 text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 pb-24">
        ...
        {currentSection === 0 && (
          <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 border border-white/20">
            <div className="flex items-start gap-3">
              <BookOpen className="w-5 sm:w-6 h-5 sm:h-6 text-amber-300 flex-shrink-0 mt-1" />
              <div>
        ...
        {!showQuiz && <EnhancedLessonContent lessonId={parseInt(lessonId)} subject="civil" />}
        ...
        {/* Quiz Section */}
        {showQuiz && hasQuiz && (
          <div className="bg-gradient-to-r from-amber-500/20 to-orange-500/20 backdrop-blur-sm rounded-xl sm:rounded-2xl p-5 sm:p-8 mb-6 sm:mb-8 border border-amber-400/30">
            <div className="flex items-center gap-3 mb-4 sm:mb-6">
              <Brain className="w-6 sm:w-8 h-6 sm:h-8 text-amber-300" />
              <div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span>{option}</span>
                        {showResult && isCorrect && <CheckCircle className="w-4 sm:w-5 h-4 sm:h-5 text-green-400 ml-auto" />}
                        {showResult && isSelected && !isCorrect && <XCircle className="w-4 sm:w-5 h-4 sm:h-5 text-red-400 ml-auto" />}
                      </div>
                    </button>
                  );
                })}
        ...
        <div className="flex items-center justify-between gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg font-semibold transition-all shadow-lg text-sm sm:text-base"
          >
