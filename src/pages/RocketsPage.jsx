      ...
      {selectedModel ? (
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {rocketModels.map((model) => (
              <div
                key={model.id}
                onClick={() => setSelectedModel(model)}
                className="group bg-gray-800/50 backdrop-blur rounded-xl p-6 border border-gray-700 hover:border-cyan-500 transition-all cursor-pointer hover:scale-105"
              >
