...
export default function CarLessonPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-900 via-gray-900 to-black text-white pb-20 md:pb-0">
      {/* Header */}
      <div className="border-b border-white/20 bg-gray-900/80 backdrop-blur-sm sticky top-0 z-10">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-12">
        ...
        <div className="mb-6 sm:mb-8">
          <div className="flex items-center gap-3 mb-4">
            <div className="text-4xl sm:text-6xl">{lesson.emoji}</div>
        ...
        {currentSection === 0 && (
          <div className="bg-white/10 backdrop-blur-sm rounded-xl sm:rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 border border-white/20">
            <div className="flex items-start gap-3">
              <BookOpen className="w-5 sm:w-6 h-5 sm:h-6 text-orange-300 flex-shrink-0 mt-1" />
              <div>
        ...
        <EnhancedLessonContent lessonId={parseInt(lessonId)} subject="cars" />
            ...
            <div className="grid gap-3 sm:gap-4">
              {lesson.content.vocabulary.map((item, index) => (
                <div key={index} className="border-l-4 border-orange-400 pl-3 sm:pl-4">
                  <div className="font-bold text-orange-300 text-sm sm:text-base">{item.term}</div>
        ...
        <div className="flex items-center justify-between gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 sm:px-8 py-2 sm:py-3 bg-gradient-to-r from-orange-500 to-red-600 hover:from-orange-600 hover:to-red-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg font-semibold transition-all shadow-lg text-sm sm:text-base"
          >
