...
export default function RocketLessonPageNew() {
  const { lessonId } = useParams();
  const navigate = useNavigate();
  const [currentSection, setCurrentSection] = useState(0);
  const [lessonCompleted, setLessonCompleted] = useState(false);
  
  const lesson = rocketsLessons[parseInt(lessonId)];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-950 via-purple-950 to-black text-white">
      {/* Header */}
      <div className="border-b border-purple-700 bg-purple-900/80 backdrop-blur-sm sticky top-0 z-10">
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            onClick={handleNext}
            className="flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 rounded-lg font-semibold transition-all shadow-lg"
          >
