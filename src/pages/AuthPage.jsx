        ...
        <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-8 shadow-2xl">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              type="button"
              className="w-full flex items-center justify-center gap-3 bg-black hover:bg-gray-900 text-white font-medium py-3 px-4 rounded-lg transition-colors border border-gray-700"
            >
