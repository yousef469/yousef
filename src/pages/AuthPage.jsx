...
import { Rocket, Mail, Lock, User, Sparkles, AlertCircle, Globe } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center p-4">
      ...
      <button
        ...
        className="fixed top-4 right-4 z-10 flex items-center gap-2 px-4 py-2 bg-gray-800/80 hover:bg-gray-700 backdrop-blur border border-gray-600 rounded-lg transition-colors text-sm font-medium text-white"
        ...
        <div className="bg-gray-800/50 backdrop-blur-xl border border-gray-700 rounded-2xl p-8 shadow-2xl">
            ...
            >
              {loading ? (
                ...
                <>
                  ...
                  <span>{isLogin ? t('nav.login') : t('auth.createAccount')}</span>
                </>
              )}
            </button>
          </form>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gray-800/50 text-gray-400">{t('auth.continueWith')}</span>
            </div>
          </div>
