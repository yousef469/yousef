          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-purple-200">20 Lessons • Master electronics and robotics</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
        <div className="space-y-12">
          {units.map((unit, unitIndex) => {
            ...
            const levelInfo = {
              0: { name: 'BEGINNER', subtitle: 'Foundations and power systems', color: 'from-green-500 to-emerald-600', icon: '🟢' },
              2: { name: 'ADVANCED', subtitle: 'Embedded systems and robotics', color: 'from-blue-500 to-cyan-600', icon: '🔵' }
            };
              ...
              <div key={unitIndex} className="relative">
                ...
                <div className="mb-20 text-center">
                  <div className={`inline-block px-8 py-3 rounded-2xl border-2 ${
                    ...
                    unit.lessons[0].level === 'Intermediate' ? 'bg-yellow-500/20 border-yellow-400' :
                    unit.lessons[0].level === 'Advanced' ? 'bg-blue-500/20 border-blue-400' :
