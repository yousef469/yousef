...
const MODELS = [
  ...
  },
  {
    ...
    specs: { thrust: '72,000 kN', stages: 2, mass: '5,000,000 kg', height: '120m' },
  ...
  },
  {
    ...
    specs: { hp: '502 HP', weight: '1,435 kg', topSpeed: '318 km/h', acceleration: '3.4s 0-100km/h' },
  ...
  },
  {
    ...
    name: 'McLaren 720S',
    category: 'cars',
    path: '/models/mclaren_720s.glb',
    thumbnail: 'https://images.unsplash.com/photo-1563720360172-67b8f3dce741?w=200&h=150&fit=crop',
    specs: { hp: '710 HP', weight: '1,283 kg', topSpeed: '341 km/h', acceleration: '2.9s 0-100km/h' },
    description: 'Supercar with carbon fiber monocoque chassis',
    type: 'Cars'
  },
  {
    id: 'f22',
  ...
  },
  {
    ...
    category: 'planes',
    path: '/models/boeing_787.glb',
    thumbnail: 'https://images.unsplash.com/photo-1436491865332-7a61a109cc05?w=200&h=150&fit=crop',
    specs: { cruiseSpeed: '913 km/h', passengers: '242-330', range: '14,140 km', wingspan: '60m' },
    description: 'Long-range, fuel-efficient wide-body airliner',
    type: 'Planes'
  }
];
