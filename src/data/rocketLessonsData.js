...
export const rocketLessons = {
  ...
  4: {
    module: 1,
    title: "Forces in Flight: Gravity, Drag, and Thrust",
    duration: "6-7 min",
    concept: "Understanding the three main forces and net force",
    
    // 1️⃣ Hook (0-1 min)
    hook: {
      question: "Why does a rocket shake and slow down right after launch?",
      animation: "Slow-motion launch: flames push down, smoke expands, rocket barely moves at first",
      points: [
        "The 3 main forces acting on a rocket",
        "How thrust must balance gravity and drag",
        "What 'net force' means in simple terms",
        "Why rockets accelerate faster as they climb"
      ]
    },
    ...
    concepts: [
      {
        title: "Thrust (↑)",
        description: "Engine push upward from burning fuel",
        icon: "🔥",
        details: "Generated by expelling hot gases at high speed"
      },
      {
        title: "Gravity (↓)",
        description: "Earth pulling the rocket down",
        icon: "🌍",
        details: "Always acts downward with constant force (weight = mass × 9.8 m/s²)"
      },
      {
        title: "Drag (↓)",
        description: "Air resistance slowing the rocket",
        icon: "💨",
        details: "Increases with speed and air density, decreases at higher altitudes"
      }
    ],
    
    netForce: {
      formula: "Net Force = Thrust - (Gravity + Drag)",
      outcomes: [
        "When Net Force > 0 → rocket accelerates 🚀",
        "When Net Force = 0 → rocket hovers ⏸️",
        "When Net Force < 0 → rocket falls 📉"
      ]
    },
    
    // 3️⃣ Interactive Simulation (3-5 min)
    simulation: {
      title: "Balance the Forces!",
      instruction: "Use sliders to adjust thrust, weight, and drag to control the rocket",
      controls: {
        thrust: { min: 0, max: 3000, unit: "N" },
        weight: { min: 500, max: 2000, unit: "N" },
        drag: { min: 0, max: 500, unit: "N" }
      },
      visualBar: "Forces add up → rocket reacts in real-time",
      challenges: [
        "Make the rocket hover (Net Force = 0)",
        "Launch with maximum acceleration",
        "Simulate high-altitude flight (low drag)"
      ]
    },
    
    // 4️⃣ Wrap-Up (5-6 min)
    summary: {
      text: "A rocket's path depends on three forces — thrust pushes up, gravity and drag pull down. The net force determines whether it accelerates, hovers, or falls.",
      icons: {
        thrust: "🔥",
        gravity: "🌍",
        drag: "💨"
      },
      keyTakeaway: "As rockets climb higher, drag decreases (thinner air), so they accelerate faster even with the same thrust!"
    },
    ...
    quiz: [
      {
        type: "visual-match",
        question: "Match the force arrows to their directions",
        instruction: "Drag arrows: thrust (up), drag + gravity (down)",
        goal: "Reinforce force directions",
        correctAnswer: { thrust: "up", gravity: "down", drag: "down" }
      },
      {
        type: "calculation",
        question: "If thrust = 1200 N, and gravity + drag = 1000 N, does the rocket rise?",
        options: ["Yes, net force is positive", "No, net force is negative", "It hovers", "Not enough information"],
        correctAnswer: "Yes, net force is positive",
        goal: "Apply logic to force balance"
      },
      {
        type: "simulation",
        question: "Adjust thrust until the rocket hovers",
        instruction: "Balance forces so Net Force = 0",
        goal: "Apply forces balance concept",
        successCondition: "thrust equals (gravity + drag)"
      }
    ],
    
    // ✅ Learning Outcomes
    outcomes: [
      "Learner understands the three main forces on a rocket",
      "Can calculate net force and predict rocket motion",
      "Knows why rockets accelerate faster at higher altitudes"
    ],
    
    // 🔓 Unlocks
    unlocks: "Lesson 5: Control and Stability — Keeping the Rocket Straight"
  },
  5: {
    module: 1,
    title: "Control and Stability: Keeping the Rocket Straight",
    duration: "6-8 min",
    concept: "Understanding center of mass, center of pressure, and stability control",
    
    // 1️⃣ Hook (0-1 min)
    hook: {
      question: "Oops — it spun out of control! What went wrong?",
      animation: "Unstable rocket spinning and tumbling out of control",
      points: [
        "Why rockets wobble or spin",
        "What center of mass and center of pressure mean",
        "How fins and gimbals stabilize flight",
        "Real-world examples from SpaceX and NASA"
      ]
    },
    ...
    concepts: [
      {
        title: "Center of Mass (CM)",
        description: "The rocket's balance point where all mass is concentrated",
        icon: "⚖️",
        details: "Like balancing a pencil on your finger — that's the CM"
      },
      {
        title: "Center of Pressure (CP)",
        description: "The point where air pushes on the rocket",
        icon: "💨",
        details: "Determined by the rocket's shape and fins"
      },
      {
        title: "Stability Rule",
        description: "For stability: CP must be BEHIND CM",
        icon: "✅",
        details: "If CP is ahead of CM, the rocket will spin out of control"
      }
    ],
    ...
    stabilityMethods: [
      {
        method: "Fins",
        icon: "🪶",
        description: "Keep flight straight by resisting rotation",
        details: "Larger fins = more stability, but more drag"
      },
      {
        method: "Gimbals",
        icon: "⚙️",
        description: "Move the engine slightly to steer",
        details: "Used in Falcon 9 for precise control"
      },
      {
        method: "RCS (Reaction Control System)",
        icon: "💨",
        description: "Small thrusters for rotation control in space",
        details: "No air in space, so fins don't work — need RCS"
      }
    ],
    
    // 3️⃣ Interactive Demo (3-5 min)
    simulation: {
      title: "Stabilize Your Rocket",
      instruction: "Adjust fins and gimbal to keep the rocket flying straight",
      controls: {
        finSize: { min: 0, max: 100, unit: "%" },
        finPosition: { options: ["Top", "Middle", "Bottom"] },
        gimbalAngle: { min: -10, max: 10, unit: "degrees" }
      },
      stabilityGauge: "Shows stability level changing dynamically",
      challenges: [
        "Move fins to bottom → see rocket stabilize",
        "Try gimbaling the nozzle → keep rocket vertical",
        "Remove fins → watch rocket tumble"
      ]
    },
    
    // 4️⃣ Wrap-Up (5-6 min)
    summary: {
      text: "A stable rocket keeps its center of pressure behind its center of mass. Fins, gimbals, and RCS help control direction and balance.",
      icons: {
        cm: "⚖️",
        cp: "💨",
        fins: "🪶"
      },
      keyTakeaway: "Stability is like a weathervane — the heavy part (CM) leads, and the fins (CP) follow behind!"
    },
    ...
    quiz: [
      {
        type: "visual-match",
        question: "Label CM and CP on the rocket diagram",
        instruction: "Place CM near the fuel tanks, CP near the fins",
        goal: "Reinforce position understanding",
        correctAnswer: { cm: "upper-middle", cp: "bottom-near-fins" }
      },
      {
        type: "multiple-choice",
        question: "If CP is ahead of CM, the rocket will...",
        options: [
          "Spin out of control",
        ...
        correctAnswer: "Spin out of control",
        goal: "Check understanding of stability"
      },
      {
        type: "simulation",
        question: "Adjust fin size for maximum stability",
        instruction: "Increase fin size until stability gauge is green",
        goal: "Apply stability concept",
        successCondition: "finSize > 60%"
      }
    ],
    
    // ✅ Learning Outcomes
    outcomes: [
      "Learner understands center of mass and center of pressure",
      "Knows the stability rule (CP behind CM)",
      "Can identify methods to stabilize a rocket"
    ],
    
    // 🔓 Unlocks
    unlocks: "Lesson 6: Trajectory and Flight Path — How Rockets Aim for Space"
  },
  6: {
    module: 1,
    title: "Trajectory and Flight Path: How Rockets Aim for Space",
    duration: "7-8 min",
    concept: "Understanding launch angles, gravity turns, and orbital mechanics",
    
    // 1️⃣ Hook (0-1 min)
    hook: {
      question: "Why do rockets tilt after takeoff — shouldn't they go straight up?",
      animation: "SpaceX Falcon 9 launch slowly curving sideways",
      points: [
        "The idea of trajectory and launch angle",
        "Why rockets don't go straight up",
        "What a gravity turn is",
        "How velocity and angle combine to reach orbit"
      ]
    },
    ...
    concepts: [
      {
        title: "Going Up Isn't Enough",
        description: "Going straight up only reaches space briefly, then falls back",
        icon: "⬆️",
        details: "You need horizontal speed to stay in orbit"
      },
      {
        title: "Orbital Velocity",
        description: "To stay in orbit, rockets must go sideways fast (~28,000 km/h or 17,500 mph)",
        icon: "🌍",
        details: "At this speed, you're falling around Earth instead of into it"
      },
      {
        title: "Gravity Turn",
        description: "Rockets use Earth's gravity to bend their path gently and save fuel",
        icon: "↗️",
        details: "Start vertical, then gradually tilt to horizontal"
      }
    ],
    
    analogy: {
      text: "Throw a ball — the faster you throw, the farther it curves around Earth. Fast enough, and it never hits the ground!",
      icon: "⚾"
    },
    
    // 3️⃣ Interactive Simulation (3-5 min)
    simulation: {
      title: "Choose Your Launch Angle",
      instruction: "Select launch angle (0°–90°) and thrust to reach orbit",
      controls: {
        launchAngle: { min: 0, max: 90, unit: "degrees", optimal: 45 },
        thrust: { min: 0, max: 100, unit: "%" }
      },
      outcomes: [
        "Too vertical (>80°) → reaches space but falls back down",
        "Too horizontal (<20°) → burns up in atmosphere",
        "Just right (~45°) → stable orbit achieved 🎯"
      ],
      graph: "Altitude vs. Velocity trajectory plot",
      realExamples: [
        "Falcon 9: Starts at 90°, tilts to 45° by 1 minute",
        "Saturn V: Similar gravity turn profile",
        "Space Shuttle: Rolled to correct angle after launch"
      ]
    },
    
    // 4️⃣ Wrap-Up (6-7 min)
    summary: {
      text: "Orbit isn't just about going up — it's about going fast enough sideways to keep falling around Earth forever. The gravity turn is the most fuel-efficient way to get there.",
      icons: {
        trajectory: "↗️",
        orbit: "🌍",
        gravity: "🪐"
      },
      keyTakeaway: "Orbiting is controlled falling! You're moving so fast sideways that you miss the Earth as you fall.",
      funFact: "The International Space Station travels at 27,600 km/h (17,150 mph) — that's 5 miles per second!"
    },
    ...
    quiz: [
      {
        type: "visual",
        question: "Identify the correct launch angle for reaching orbit",
        instruction: "Select the trajectory that curves from vertical to horizontal",
        goal: "Visual understanding of gravity turn",
        correctAnswer: "gradual-curve-45-degrees"
      },
      {
        type: "multiple-choice",
        question: "Why do rockets tilt after launch?",
        options: [
          "To gain horizontal speed for orbit",
          "To avoid clouds",
          "To look more dramatic",
          "To reduce fuel consumption only"
        ],
        correctAnswer: "To gain horizontal speed for orbit",
        goal: "Concept check on orbital mechanics"
      },
      {
        type: "simulation",
        question: "Adjust launch angle to reach stable orbit",
        instruction: "Find the angle that achieves both altitude and horizontal velocity",
        goal: "Apply physics of trajectory",
        successRange: [40, 50]
      }
    ],
    ...
    // ✅ Learning Outcomes
    outcomes: [
      "Learner understands forces, stability, and trajectories",
      "Can explain why rockets tilt during launch",
      "Knows the difference between reaching space and reaching orbit"
    ],
    
    // 🎓 Unit Complete
    unitComplete: {
      message: "Congratulations! You've finished Beginner Level (Unit 1)",
      achievements: [
        "✅ Mastered rocket flight basics",
        "✅ Understood forces and stability",
        "✅ Learned orbital mechanics"
      ],
      nextUnit: "Intermediate Level (Unit 2) — Propulsion Systems Deep Dive"
    },
    
    // 🔓 Unlocks
    unlocks: "Unit 2: Propulsion Systems Deep Dive"
  },
